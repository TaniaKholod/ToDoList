...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (1, 'Mike', 'Brown', 'mike@mail.com', '$2a$12$9KFQ6.PNzSLbJRQ7dH5ENue5KJM5hYPign.64yRSj9zI/29IULsOi', 1);
...
INSERT INTO tasks (id, name, priority, todo_id, state_id) VALUES (4, 'Task #4', 'MEDIUM', 4, 2);
